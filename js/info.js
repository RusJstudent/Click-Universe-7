...
Don't attack quattroid until you will be able 
to kill 4-5 magmiuses in a row! It's a very strong.
...
Use autofarm button to develop faster (click it or press "Q")
To open menu you may press "P"`;
...
made today:
added first version of menu
small changes:
- now is not possible to repair during fight if you sell / buy shields or upgrade ship
- use key "Q" to activate / deactivate autofarm
- use "P" to open / close menu
